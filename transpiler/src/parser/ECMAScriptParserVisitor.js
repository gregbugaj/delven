...
export default class ECMAScriptParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitInlinedQueryExpression(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by ECMAScriptParser#let_.
	visitLet_(ctx) {
	  return this.visitChildren(ctx);
	}
