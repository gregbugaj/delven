...
describe("Queryable Skip", () => {
    ...
    test("skip-toArray()", async () => {
        let enumerable = new Enumerable([0, 1, 2, 3, 4, 5, 6, 7, 8]).AsQueryable()
    ...
    test("skip-iterator", async () => {
        const enumerable = new Enumerable([0, 1, 2, 3, 4, 5, 6, 7, 8]).AsQueryable()
    ...
    test("skip-outofrange-iterable", async () => {
        const data = [0, 1, 2, 3, 4, 5, 6, 7, 8]
        const enumerable = data.asEnumerable().AsQueryable()
        const results = []
