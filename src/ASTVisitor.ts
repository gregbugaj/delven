...
export default abstract class ASTVisitor<T> {
   ...
   * @param property
   */
  abstract visitObjectExpressionProperty(
    expression: Node.ObjectExpressionProperty
  ): T;

  /**
   * @param expression
   */
  abstract visitArrowFunctionExpression(
    expression: Node.AsyncFunctionExpression
  ): T;
  ...
  abstract visitMemberExpression(
    expression: Node.StaticMemberExpression | Node.ComputedMemberExpression
  ): T;
  /**
   *
   * @param expression
   ...
   * @param statement
   */
  abstract visitExportNamedDeclaration(
    statement: Node.ExportNamedDeclaration
  ): T;
   ...
   * @param statement
   */
  abstract visitOptionalMemberExpression(
    expression: Node.OptionalMemberExpression
  ): T;
   ...
   * @param expression
   */
  abstract visitOptionalCallExpression(
    expression: Node.OptionalCallExpression
  ): T;
   ...
   * @param expression
   */
  abstract visitTaggedTemplateExpression(
    expression: Node.TaggedTemplateExpression
  ): T;
