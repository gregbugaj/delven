...
export default class DocumentBuilder {
    ...
    toSource() {
        ...
        const printToBuffer = (node: Chunk, depth: number) => {
            ...
            let isBracelessGroup = node.options?.bracelessGroup ? node.options?.bracelessGroup : false

            if (false) {
                console.info(`isGrouped = ${isGrouped} , isFlat = ${isFlat}, isBracelessGroup = ${isBracelessGroup}`)
            }
