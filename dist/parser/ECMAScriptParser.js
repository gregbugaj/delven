...
ECMAScriptParser.Class = 98;
ECMAScriptParser.Enum = 99;
ECMAScriptParser.Extends = 100;
ECMAScriptParser.Super = 101;
ECMAScriptParser.Const = 102;
ECMAScriptParser.Export = 103;
ECMAScriptParser.Import = 104;
ECMAScriptParser.Async = 105;
ECMAScriptParser.Await = 106;
ECMAScriptParser.Implements = 107;
ECMAScriptParser.StrictLet = 108;
ECMAScriptParser.NonStrictLet = 109;
ECMAScriptParser.Private = 110;
ECMAScriptParser.Public = 111;
ECMAScriptParser.Interface = 112;
ECMAScriptParser.Package = 113;
ECMAScriptParser.Protected = 114;
ECMAScriptParser.Static = 115;
ECMAScriptParser.Yield = 116;
ECMAScriptParser.Identifier = 117;
ECMAScriptParser.StringLiteral = 118;
ECMAScriptParser.TemplateStringLiteral = 119;
ECMAScriptParser.WhiteSpaces = 120;
ECMAScriptParser.LineTerminator = 121;
ECMAScriptParser.HtmlComment = 122;
ECMAScriptParser.CDataComment = 123;
ECMAScriptParser.UnexpectedCharacter = 124;
ECMAScriptParser.Let = 125;
...
ECMAScriptParser.prototype.iterationStatement = function() {
    ...
    try {
        ...
        case 3:
            ...
            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ECMAScriptParser.RegularExpressionLiteral) | (1 << ECMAScriptParser.OpenBracket) | (1 << ECMAScriptParser.OpenParen) | (1 << ECMAScriptParser.OpenBrace) | (1 << ECMAScriptParser.PlusPlus) | (1 << ECMAScriptParser.MinusMinus) | (1 << ECMAScriptParser.Plus) | (1 << ECMAScriptParser.Minus) | (1 << ECMAScriptParser.BitNot) | (1 << ECMAScriptParser.Not))) !== 0) || ((((_la - 59)) & ~0x1f) == 0 && ((1 << (_la - 59)) & ((1 << (ECMAScriptParser.NullLiteral - 59)) | (1 << (ECMAScriptParser.BooleanLiteral - 59)) | (1 << (ECMAScriptParser.DecimalLiteral - 59)) | (1 << (ECMAScriptParser.HexIntegerLiteral - 59)) | (1 << (ECMAScriptParser.OctalIntegerLiteral - 59)) | (1 << (ECMAScriptParser.Typeof - 59)) | (1 << (ECMAScriptParser.New - 59)) | (1 << (ECMAScriptParser.Void - 59)) | (1 << (ECMAScriptParser.Function - 59)) | (1 << (ECMAScriptParser.This - 59)))) !== 0) || ((((_la - 93)) & ~0x1f) == 0 && ((1 << (_la - 93)) & ((1 << (ECMAScriptParser.Delete - 93)) | (1 << (ECMAScriptParser.Identifier - 93)) | (1 << (ECMAScriptParser.StringLiteral - 93)))) !== 0)) {
                this.state = 202;
                this.expressionSequence();
            }
...
ECMAScriptParser.prototype.numericLiteral = function() {
    ...
    try {
        ...
        this.state = 592;
        _la = this._input.LA(1);
        if(!(((((_la - 61)) & ~0x1f) == 0 && ((1 << (_la - 61)) & ((1 << (ECMAScriptParser.DecimalLiteral - 61)) | (1 << (ECMAScriptParser.HexIntegerLiteral - 61)) | (1 << (ECMAScriptParser.OctalIntegerLiteral - 61)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
ECMAScriptParser.prototype.keyword = function() {
    ...
    try {
        ...
        this.state = 603;
        _la = this._input.LA(1);
        if(!(((((_la - 70)) & ~0x1f) == 0 && ((1 << (_la - 70)) & ((1 << (ECMAScriptParser.Break - 70)) | (1 << (ECMAScriptParser.Do - 70)) | (1 << (ECMAScriptParser.Instanceof - 70)) | (1 << (ECMAScriptParser.Typeof - 70)) | (1 << (ECMAScriptParser.Case - 70)) | (1 << (ECMAScriptParser.Else - 70)) | (1 << (ECMAScriptParser.New - 70)) | (1 << (ECMAScriptParser.Var - 70)) | (1 << (ECMAScriptParser.Catch - 70)) | (1 << (ECMAScriptParser.Finally - 70)) | (1 << (ECMAScriptParser.Return - 70)) | (1 << (ECMAScriptParser.Void - 70)) | (1 << (ECMAScriptParser.Continue - 70)) | (1 << (ECMAScriptParser.For - 70)) | (1 << (ECMAScriptParser.Switch - 70)) | (1 << (ECMAScriptParser.While - 70)) | (1 << (ECMAScriptParser.Debugger - 70)) | (1 << (ECMAScriptParser.Function - 70)) | (1 << (ECMAScriptParser.This - 70)) | (1 << (ECMAScriptParser.With - 70)) | (1 << (ECMAScriptParser.Default - 70)) | (1 << (ECMAScriptParser.If - 70)) | (1 << (ECMAScriptParser.Throw - 70)) | (1 << (ECMAScriptParser.Delete - 70)) | (1 << (ECMAScriptParser.In - 70)) | (1 << (ECMAScriptParser.Try - 70)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
ECMAScriptParser.prototype.futureReservedWord = function() {
    ...
    try {
        ...
        this.state = 605;
        _la = this._input.LA(1);
        if(!(((((_la - 98)) & ~0x1f) == 0 && ((1 << (_la - 98)) & ((1 << (ECMAScriptParser.Class - 98)) | (1 << (ECMAScriptParser.Enum - 98)) | (1 << (ECMAScriptParser.Extends - 98)) | (1 << (ECMAScriptParser.Super - 98)) | (1 << (ECMAScriptParser.Const - 98)) | (1 << (ECMAScriptParser.Export - 98)) | (1 << (ECMAScriptParser.Import - 98)) | (1 << (ECMAScriptParser.Implements - 98)) | (1 << (ECMAScriptParser.Private - 98)) | (1 << (ECMAScriptParser.Public - 98)) | (1 << (ECMAScriptParser.Interface - 98)) | (1 << (ECMAScriptParser.Package - 98)) | (1 << (ECMAScriptParser.Protected - 98)) | (1 << (ECMAScriptParser.Static - 98)) | (1 << (ECMAScriptParser.Yield - 98)) | (1 << (ECMAScriptParser.Let - 98)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
